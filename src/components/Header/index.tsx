    ...
    <header className=" px-6 pt-6 pb-6 lg:px-8 ">
      <nav className="flex items-center justify-between" aria-label="Global">
          ...
          <div className="inline-flex gap-4 items-center">
            <Link href="#" className="inline-flex items-center justify-center">
              <Image
                ...
                width={32}
                height={32}
                className="bg-white mx-auto rounded-full dark:hover:bg-green-700 hover:bg-green-700"
              />
              <h1 className="text-xl font-semibold ">
                <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white dark:hover:text-green-700 hover:text-green-700">
                  <span className="text-2xl text-slate-900 dark:text-white px-2 dark:hover:text-green-700 hover:text-green-700">
                    &#123;
                  </span>
                  Tobias Maneschijn
                  <span className="text-2xl text-slate-900 dark:text-white px-2 dark:hover:text-green-700 hover:text-green-700">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <DarkInner
            className="dark:text-white dark:hover:text-green-700 hover:text-green-700"
            toggled={darkMode}
            toggle={() => toggle()}
          />
        </div>
            ...
            <Link href="/" className="-m-1.5 p-1.5">
              <h1 className="text-xl font-semibold">
                <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white">
                  <span className="text-2xl text-slate-900 px-2 dark:text-white">
                    &#123;
                  </span>
                  Tobias Maneschijn
                  <span className="text-2xl text-slate-900 px-2 dark:text-white">
